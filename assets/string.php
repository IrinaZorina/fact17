...
<body>
  ...
  ?>
  <main>
  <p><b class="zadanie">Задание 1</b> Дана строка. Если в этой строке более 5-ти символов - вырежьте из нее первые 5 символов,
   добавьте троеточие в конец и выведите на экран. Если же в этой строке 5 и менее символов - необходимо вывести эту строку на экран.</p>
    <p><b>Результат</b></p>
    <?php
$str = "hellooooooo";
if (strlen($str) > 5) {
...
?>
<p><b class="zadanie">Задание 2</b> Дана строка $str. Замените в ней все буквы 'a' на цифру 1, буквы 'b' - на 2, а буквы 'c' - на 3.</p>
    <p><b>Результат</b></p>
    <?php
  $str = "abcd abcd";
